 ...
 * This gets prepended to the ground truth before sending to
 * SITREP and forecast agents so they have foundational knowledge.
 */
export const BASE_CONTEXT = `## CONFLICT BACKGROUND & KEY FACTS
